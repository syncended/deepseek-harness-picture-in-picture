...
@media (prefers-reduced-motion: reduce) {
  .dsh-pip-launcher, .dsh-pip-dot, .dsh-pip-launcher-badge, .dsh-pip-fish, .dsh-pip-activity-row::after { animation: none !important; transition: none !important; }
    ...
    exports.__testing = { copyForLocale, languageForLocale, textOfContent, imagesOfContent, textOfAssistant, answerTextOfAssistant, projectNode, visibleConversationRows, displayName, modelChoicesOf, contextPercent, statsSegments, todoSummary, sessionRows, sessionGroups, stateOf };
