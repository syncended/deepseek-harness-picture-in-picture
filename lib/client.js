...
body.dsh-pip-window { box-sizing: border-box; width: 100vw; height: 100vh; margin: 0; min-width: 280px; min-height: 300px; padding: 6px; overflow: hidden; background: color-mix(in srgb, var(--dsh-pip-bg) 88%, var(--dsh-pip-muted)); }
body.dsh-pip-window #dsh-picture-in-picture-root { width: 100%; height: 100%; }
body.dsh-pip-window .dsh-pip-root { box-sizing: border-box; border: 1px solid var(--dsh-pip-border); border-radius: 25px; overflow: hidden; box-shadow: 0 10px 30px rgba(0, 0, 0, .16); }
